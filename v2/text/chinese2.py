...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(model_dir="text/G2PWModel",model_source=os.environ.get("bert_path","pretrained_models/chinese-roberta-wwm-ext-large"),v_to_u=False, neutral_tone_with_five=True)
